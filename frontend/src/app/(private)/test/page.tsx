...
export default async function TestPage (){
    ...
    let pressReviews: { id: string; title: string; description: string; content: string }[] | undefined
    let messages: { id: string; type: "user" | "ai"; content: string; timestamp: string }[] | undefined

    try {
        const file = await fs.readFile(process.cwd() + '/data/mockData.json', 'utf8')
    ...
    return (    
        <div className="h-max bg-[#343434] flex gap-50 flex-wrap px-12 py-12">
            <div className="flex flex-col gap-4">
                <h2 className="border border-brand-velvet rounded-l px-4 py-4">Menu ui </h2>
                <Menu chats={chats}/>
            </div>
            
            <div className="flex flex-col gap-4">
                <h2 className="border border-brand-velvet rounded-l px-4 py-4">Input ui </h2>
                <Input label="Email" placeholder="Enter your email" type="email"/>
            </div>

            <div className="flex flex-col gap-4">
                <h2 className="border border-brand-velvet rounded-l px-4 py-4">Robot & Logo</h2>
            ...
            <div className="flex flex-col gap-4">
                <h2 className="border border-brand-velvet rounded-l px-4 py-4">Press Review</h2>
            ...
            <div className="flex flex-col gap-4">
                <h2 className="border border-brand-velvet rounded-l px-4 py-4">Messages</h2>
            ...
            <div className="flex flex-col gap-4">
            <h2 className="border border-brand-velvet rounded-l px-4 py-4">TextArea</h2>
                <TextArea />
            </div>

            <div className="flex flex-col gap-4">
            <h2 className="border border-brand-velvet rounded-l px-4 py-4">ButtonSend</h2>
                <ButtonSend />
            </div>

            <div className="flex flex-col gap-4">
            <h2 className="border border-brand-velvet rounded-l px-4 py-4">ButtonSubMenu</h2>
                <ButtonSubMenu type_="chat" active />
                <ButtonSubMenu type_="review" />
            </div>

            <div className="flex flex-col gap-4 bg-white">
            <h2 className="border border-brand-velvet rounded-l px-4 py-4">Chips</h2>
            ...
            <div className="flex flex-col gap-4">
            <h2 className="border border-brand-velvet rounded-l px-4 py-4">ButtonReview</h2>
                <ButtonReview />
            </div>
        </div>
    )
