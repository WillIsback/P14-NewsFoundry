...
export default function AssistantWelcome() {
	return (
		<>
			<div className="flex flex-col w-full max-w-102.5 h-fit items-center gap-6">
				<Robot variant={"default"} />
				<h1 className="text-brand-velvet">Assistant Revue de Presse IA</h1>
			</div>
			<p className="flex w-full h-fit gap-2.5 px-2 flex-wrap items-center justify-center text-slate-700">
			...
			<div className="flex w-full h-fit flex-col items-center gap-2.25">
				<p className="font-bold text-slate-800">Exemples :</p>
