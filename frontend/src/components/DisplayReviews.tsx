...
export default function DisplayReviews({ pressReviews }: Readonly<{ pressReviews?: { id: string; title: string; description: string; content: string }[] }> ) {
  return (
    <div className="flex flex-col h-full min-h-0">
      <header className="flex flex-col h-fit w-105.5 shrink-0">
        <h1 className="text-2xl font-bold">Revues de Presse</h1>
        <p className="text-slate-600">Consultez et férez vos revues de presse générées par l&apos;IA</p>
      </header>
